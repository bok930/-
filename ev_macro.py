...
class App:
    def __init__(self, root):
        ...
        ttk.Scale(match_row, from_=0.65, to=0.95, variable=self.conf,
                  orient="horizontal", length=180).pack(side="left", padx=10)
        ...
        btns = ttk.Frame(root)
        btns.pack(pady=14)
        ttk.Button(btns, text="서버시간 동기화", command=self.sync).pack(side="left", padx=5)
